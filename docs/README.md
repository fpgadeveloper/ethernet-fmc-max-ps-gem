...
The documentation for these example designs is hosted at <https://psgem-sgmii.ethernetfmc.com>
...
only wish to view the documentation, then please view it [here](https://psgem-sgmii.ethernetfmc.com).
