...
# Port 2 is not used in this design (the Versal PS has only two GEMs).
# The PHY is held in reset and the GT lane is left unconnected.
...
# Port 3 is not used in this design (the Versal PS has only two GEMs).
# The PHY is held in reset and the GT lane is left unconnected.
