...
dict set target_dict vck190_fmcp1 { xilinx.com vck190 versal { 0 1 } }
...
# Add any HDL modules referenced by the block designs
set hdl_files [glob -nocomplain "$origin_dir/src/hdl/*.v"]
